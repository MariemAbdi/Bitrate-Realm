...
class _ChatScreenState extends State<ChatScreen> {
        ...
        child: Row(
          children: [
            ...
            GestureDetector(
              ...
              child: Padding(
                padding: const EdgeInsets.all(8),
                child: Icon(Icons.telegram,color: MyThemes.darkBlue, size: MediaQuery.of(context).size.width*0.12,),
              ),
            )
          ],
        ),
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      color: Theme.of(context).brightness==MyThemes.lightTheme.brightness?MyThemes.lightBlue:Colors.white,
      backgroundColor: Theme.of(context).brightness==MyThemes.lightTheme.brightness?MyThemes.darkBlue:Colors.grey.shade800,
      onRefresh: ()async{
        _fetchData();
      },
