...
import 'package:livestream/Screens/Going%20Live/video_player.dart';
...
class _SearchScreenState extends State<SearchScreen> {
    ...
    return StreamBuilder<List<User>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            ...
            users.removeWhere((element) => element.email== context.read<FirebaseAuthMethods>().user.email);
                    ...
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(
                          builder: (context) => Scaffold(
                            body: ProfileScreen(id: users[index].email, nickname: users[index].nickname),)
                      ));
                    },
                  );
                }
  ...
  Widget searchVideosPerTitleStream(){
    return StreamBuilder<List<LiveStream>>(
        stream: getAllVideos(field, isDescending),
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            return Center(
              child: Text(
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                    ...
                    leading: SizedBox(
                      ...
                      width: 50,
                      child: FutureBuilder(
                        future: storage.downloadURL("video thumbnail", videos[index].thumbnail),
