                      ...
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(LocaleKeys.rateUs.tr(), style: GoogleFonts.ptSans(fontSize:18,fontWeight: FontWeight.w700, color: isLight?MyThemes.darkBlue:Colors.white.withOpacity(0.8)),),
                            ...
                            Text("$_rating/5.0", style: GoogleFonts.ptSans(fontSize:18,fontWeight: FontWeight.w700, color: isLight?MyThemes.darkBlue:Colors.white.withOpacity(0.8)),),

                            const SizedBox(height: 25),
                            CustomButton(text: LocaleKeys.done.tr(), function: ()async{
                              sendEmail();
                              setState(() {
                                _rating=5.0;
                              });
                              Navigator.pop(context);
                              mySnackBar(context, LocaleKeys.ratingSentSuccessfully.tr(), Colors.green);
                            }),
                          ],
                        ),
                      );
