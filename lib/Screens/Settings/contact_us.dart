...
import 'package:livestream/Widgets/Input%20Widgets/custom_text_field.dart';
...
class _ContactUsState extends State<ContactUs> {
  ...
  Future sendEmail() async{
    ...
    body: json.encode({
      ...
      'template_params': {
        ...
        "email": context.read<FirebaseAuthMethods>().user.email,
  ...
  Future<void> _copyToClipboard(String toCopy) async {
    ...
    if (!mounted) return;
    mySnackBar(context, LocaleKeys.copiedToClipboard.tr(), Colors.orangeAccent);
  }
      ...
      child: Center(
        child: ListTile(
          ...
          leading: SizedBox(
              ...
              child: Icon(icon, color: MyThemes.darkBlue)),
          title: Text(title, style: GoogleFonts.ptSans(fontWeight: FontWeight.w700, color: MyThemes.darkBlue),),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(title, style: GoogleFonts.ptSans(fontWeight: FontWeight.w800, color: MyThemes.darkBlue, fontSize: 16),)
            ],
          ),
        ),
      ),
            ...
            child: ListView(
              ...
              children: [
               ...
               Form(
                 ...
                 Text(LocaleKeys.sendEmail.tr(), style: GoogleFonts.ptSans(fontSize:18,fontWeight: FontWeight.w700, color: MyThemes.darkBlue),),
                ...
                CustomButton(text: LocaleKeys.send.tr(), function: ()async{
