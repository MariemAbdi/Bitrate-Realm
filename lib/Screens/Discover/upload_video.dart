...
import '../../Widgets/Input Widgets/custom_text_field.dart';
                                      ...
                                      function: () async {
                                        if (_formKey.currentState?.validate() ??
                                          ...
                                          if (image == null) {
                                            ...
                                            await uploadVideo(context,_titleController.text.trim(),_descriptionController.text.trim(),"${_selectedDialogLanguage.name}(${_selectedDialogLanguage.isoCode})", tags, _dropdownValue, image, video);
                                            setState(() {
