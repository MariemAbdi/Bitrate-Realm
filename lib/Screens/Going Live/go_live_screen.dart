...
import '../../Widgets/Input Widgets/multi_line_field.dart';
                            ...
                            child: image != null
                                ? Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: MyThemes.darkBlue.withOpacity(0.05),
                                ...
                                : DottedBorder(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          color:
                                              MyThemes.darkBlue.withOpacity(0.05),
                                          borderRadius: BorderRadius.circular(10)),
                                      child: Column(
                                      ...
                                      function: () async {
                                        if (_formKey.currentState?.validate() ??
                                          ...
                                          if (image == null) {
                                            ...
                                            await startLiveStream(context, _titleController.text.trim(), _descriptionController.text.trim(), "${_selectedDialogLanguage.name}(${_selectedDialogLanguage.isoCode})", tags, _dropdownValue, image);
