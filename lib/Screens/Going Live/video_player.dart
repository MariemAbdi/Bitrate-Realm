...
class _VideoPlayerScreenState extends State<VideoPlayerScreen> {
  ...
  Future<void> getVideo() async {
    ...
    Reference videoRef = storage.ref().child('videos/${widget.video.videoUrl}.mp4');
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text(DateFormat('dd/MM/yyyy HH:mm').format(widget.video.date),style: GoogleFonts.ptSans(textStyle: const TextStyle(fontWeight: FontWeight.w400, fontSize: 14))),
                          ],
                        ),
