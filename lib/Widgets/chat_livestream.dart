        ...
        children: [
            ...
            child: Form(
              ...
              child: TextFormField(
                ...
                onFieldSubmitted: (msg){
                  //SEND MESSAGE
                  addComment(widget.collectionName, widget.docId,_chatController.text.trim(),user.displayName!, widget.docId, context);
                  _chatController.clear();
                  setState(() {});
                },
              ),
          ...
          GestureDetector(
            ...
            child: const Padding(
              ...
              child: Icon(Icons.telegram,color: MyThemes.darkBlue, size: 40,),
            ),
          )
        ],
      );
                      ...
                      itemBuilder: (context, index){
                        return ListTile(
                          ...
                          title: Row(
                            ...
                            children: [
                              Text(snapshot.data.docs[index]['nickname'], style: GoogleFonts.ptSans(fontWeight:FontWeight.w900, color: snapshot.data.docs[index]['uid'] == user.uid ? MyThemes.darkBlue : MyThemes.lightBlue),overflow: TextOverflow.ellipsis, maxLines: 1,),
