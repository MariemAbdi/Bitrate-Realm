        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              CustomButton(text: LocaleKeys.edit.tr(), onPressed: () async{
                if (_formKey.currentState?.validate() ?? false) {
                  ...
                  if(_nicknameController.text.trim().isNotEmpty){
                    ...
                    context.read<FirebaseAuthServices>().changePassword(context, user.email!, oldPassword, _newPasswordController.text.trim());
                    _newPasswordController.clear();
                  }
                  mySnackBar(LocaleKeys.profileUpdatedSuccessfully.tr(), Colors.green);
                }
