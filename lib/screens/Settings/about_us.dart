...
class _AboutUsState extends State<AboutUs> {
  ...
  Widget build(BuildContext context) {
    final bool _isLight= Theme.of(context).brightness==MyThemes.customTheme.brightness;
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          //------------------------TITLE------------------------
          Text(textTitle, style: GoogleFonts.ptSans(fontWeight: FontWeight.w800, color: isLight?MyThemes.primaryLight:Colors.white.withOpacity(0.8), fontSize: 24),),
          const SizedBox(height: 20,),
          //------------------------BODY------------------------
